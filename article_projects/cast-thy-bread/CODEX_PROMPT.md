...
`article_projects/cast-thy-bread/sources/`

Required final output folder:

`article_projects/cast-thy-bread/output/`
...
13. Before finishing, run `python codex_article.py validate cast-thy-bread` and fix meaningful validation failures.
